#!/usr/bin/env python3
"""
Download Census TIGER 2022 State Legislative District Lower Chamber files
and rename them with state abbreviations.

URL: https://www2.census.gov/geo/tiger/TIGER2022/SLDL/
"""
...
def download_sldl_files(base_url, output_dir='.'):
    ...
    try:
        ...
        # Parse HTML to find .zip files matching the pattern tl_2022_XX_sldl.zip
        pattern = r'tl_2022_(\d{2})_sldl\.zip'
...
if __name__ == "__main__":
    # Census TIGER 2022 SLDL directory
    CENSUS_URL = "https://www2.census.gov/geo/tiger/TIGER2022/SLDL/"
    
    # You can specify a custom output directory here
    OUTPUT_DIR = "./census_sldl_2022"
    
    print("=" * 70)
    print("Census TIGER SLDL 2022 Downloader")
    print("State Legislative District Lower Chamber (2022)")
    print("=" * 70)
    print()
