...
from the 2000 redistricting cycle and rename them with state abbreviations.

URL: https://www2.census.gov/geo/tiger/TIGER2010/SLDL/2000/
"""
...
def download_sldl_files(base_url, output_dir='.'):
    ...
    try:
        ...
        # Parse HTML to find .zip files matching the pattern tl_2010_XX_sldl00.zip
        pattern = r'tl_2010_(\d{2})_sldl00\.zip'
...
if __name__ == "__main__":
    # Census TIGER 2010 SLDL 2000 directory
    CENSUS_URL = "https://www2.census.gov/geo/tiger/TIGER2010/SLDL/2000/"
    
    # You can specify a custom output directory here
    OUTPUT_DIR = "./census_sldl_2000"
    
    print("=" * 70)
    print("Census TIGER SLDL 2000 Downloader")
    print("State Legislative District Lower Chamber (2000 Redistricting)")
    print("=" * 70)
    print()
