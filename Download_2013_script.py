#!/usr/bin/env python3
"""
Download Census TIGER 2013 State Legislative District Lower Chamber files
and rename them with state abbreviations.

These files are used for 2010-redistricting-cycle SHD/SLDL analyses.
URL: https://www2.census.gov/geo/tiger/TIGER2013/SLDL/
"""
...
def download_sldl_files(base_url, output_dir='.'):
    ...
    try:
        ...
        # Parse HTML to find .zip files matching the pattern tl_2013_XX_sldl.zip
        pattern = r'tl_2013_(\d{2})_sldl\.zip'
...
if __name__ == "__main__":
    # Census TIGER 2013 SLDL directory (used for 2010-cycle SHD analyses)
    CENSUS_URL = "https://www2.census.gov/geo/tiger/TIGER2013/SLDL/"

    # You can specify a custom output directory here
    OUTPUT_DIR = "./census_sldl_2013"

    print("=" * 70)
    print("Census TIGER SLDL 2013 Downloader")
    print("State Legislative District Lower Chamber (2010 Redistricting Cycle)")
    print("=" * 70)
    print()
