###############################################################################
# Download and prepare data for `WA_shd_2010` analysis
###############################################################################
...
cli_process_start("Downloading files for {.pkg WA_shd_2010}")
...
dir.create(here("data-out/WA_2010"), showWarnings = FALSE, recursive = TRUE)
...
if (!file.exists(here(shp_path))) {
    ...
    sldl_shp <- st_read(here("data-raw/WA/sldl_2010/tl_2013_53_sldl.shp"), quiet = TRUE) |>
    ...
    wa_shp <- fill_na_enacted(wa_shp, shd_2010)
