###############################################################################
# Download and prepare data for `NC_shd_2010` analysis
###############################################################################
...
cli_process_start("Downloading files for {.pkg NC_shd_2010}")
...
dir.create(here("data-out/NC_2010"), showWarnings = FALSE, recursive = TRUE)
...
if (!file.exists(here(shp_path))) {
    ...
    sldl_shp <- st_read(here("data-raw/NC/sldl_2010/tl_2013_37_sldl.shp"), quiet = TRUE) |>
    ...
    nc_shp <- fill_na_enacted(nc_shp, shd_2010)
