###############################################################################
# Download and prepare data for `GA_shd_2010` analysis
###############################################################################
...
cli_process_start("Downloading files for {.pkg GA_shd_2010}")
...
dir.create(here("data-out/GA_2010"), showWarnings = FALSE, recursive = TRUE)
...
if (!file.exists(here(shp_path))) {
    ...
    sldl_shp <- st_read(here("data-raw/GA/sldl_2010/tl_2013_13_sldl.shp"), quiet = TRUE) |>
    ...
    ga_shp <- fill_na_enacted(ga_shp, shd_2010)
