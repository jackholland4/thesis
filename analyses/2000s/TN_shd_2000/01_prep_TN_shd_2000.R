###############################################################################
# Download and prepare data for `TN_shd_2000` analysis
###############################################################################
...
cli_process_start("Downloading files for {.pkg TN_shd_2000}")
...
dir.create(here("data-out/TN_2000"), showWarnings = FALSE, recursive = TRUE)
...
if (!file.exists(here(shp_path))) {
    ...
    sldl_shp <- st_read(here("data-raw/TN/sldl_2000/tl_2010_47_sldl10.shp"), quiet = TRUE) |>
    ...
    tn_shp <- fill_na_enacted(tn_shp, shd_2000)
