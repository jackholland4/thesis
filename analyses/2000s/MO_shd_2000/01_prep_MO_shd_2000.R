###############################################################################
# Download and prepare data for `MO_shd_2000` analysis
###############################################################################
...
cli_process_start("Downloading files for {.pkg MO_shd_2000}")
...
dir.create(here("data-out/MO_2000"), showWarnings = FALSE, recursive = TRUE)
...
if (!file.exists(here(shp_path))) {
    ...
    sldl_shp <- st_read(here("data-raw/MO/sldl_2000/tl_2010_29_sldl10.shp"), quiet = TRUE) |>
    ...
    mo_shp <- fill_na_enacted(mo_shp, shd_2000)
