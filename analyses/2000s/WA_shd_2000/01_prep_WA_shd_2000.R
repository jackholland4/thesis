###############################################################################
# Download and prepare data for `WA_shd_2000` analysis
###############################################################################
...
cli_process_start("Downloading files for {.pkg WA_shd_2000}")
...
dir.create(here("data-out/WA_2000"), showWarnings = FALSE, recursive = TRUE)
...
if (!file.exists(here(shp_path))) {
    ...
    sldl_shp <- st_read(here("data-raw/WA/sldl_2000/tl_2010_53_sldl10.shp"), quiet = TRUE) |>
    ...
    wa_shp <- fill_na_enacted(wa_shp, shd_2000)
