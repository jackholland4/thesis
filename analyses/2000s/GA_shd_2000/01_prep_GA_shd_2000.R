###############################################################################
# Download and prepare data for `GA_shd_2000` analysis
###############################################################################
...
cli_process_start("Downloading files for {.pkg GA_shd_2000}")
...
dir.create(here("data-out/GA_2000"), showWarnings = FALSE, recursive = TRUE)
...
if (!file.exists(here(shp_path))) {
    ...
    sldl_shp <- st_read(here("data-raw/GA/sldl_2000/tl_2010_13_sldl10.shp"), quiet = TRUE) |>
    ...
    ga_shp <- fill_na_enacted(ga_shp, shd_2000)
