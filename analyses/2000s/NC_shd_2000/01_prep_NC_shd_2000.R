###############################################################################
# Download and prepare data for `NC_shd_2000` analysis
###############################################################################
...
cli_process_start("Downloading files for {.pkg NC_shd_2000}")

path_data <- download_redistricting_file("NC", "data-raw/NC", year = 2000)
...
dir.create(here("data-out/NC_2000"), showWarnings = FALSE, recursive = TRUE)
...
if (!file.exists(here(shp_path))) {
    ...
    sldl_shp <- st_read(here("data-raw/NC/sldl_2000/tl_2010_37_sldl10.shp"), quiet = TRUE) |>
    ...
    nc_shp <- fill_na_enacted(nc_shp, shd_2000)
