###############################################################################
# Download and prepare data for `LA_shd_2020` analysis
###############################################################################
...
cli_process_start("Downloading files for {.pkg LA_shd_2020}")
...
if (!file.exists(here(shp_path))) {
    ...
    sldl_shp <- st_read(here("data-raw/LA/sldl_2020/tl_2022_22_sldl.shp"), quiet = TRUE) |>
    ...
    la_shp <- fill_na_enacted(la_shp, shd_2020)
